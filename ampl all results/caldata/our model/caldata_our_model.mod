...
subject to ai1:
	adm["ABEC_A_1"]+adm["ABEC_A_2"]+adm["ABEC_A_3"]+adm["ABEC_A_4"]>=3;
subject to ai2:
	adm["ABEC_B_1"]+adm["ABEC_B_2"]+adm["ABEC_B_3"]+adm["ABEC_B_4"]+adm["BDE_B_1"]+adm["BDE_B_2"]>=4;
subject to ai3:
	adm["ABEC_E_1"]+adm["ABEC_E_2"]+adm["ABEC_E_3"]+adm["ABEC_E_4"]+adm["BDE_E_1"]+adm["BDE_E_2"]+adm["EGLKIHF_E_1"]+adm["EGLKIHF_E_2"]+adm["EGLKIHF_E_3"]>=5;
subject to ai4:
	adm["ABEC_C_1"]+adm["ABEC_C_2"]+adm["ABEC_C_3"]+adm["ABEC_C_4"]>=1;
subject to ai5:
	adm["BDE_D_1"]+adm["BDE_D_2"]>=1;
subject to ai6:
	adm["EGLKIHF_G_1"]+adm["EGLKIHF_G_2"]+adm["EGLKIHF_G_3"]>=1;
subject to ai7:
	adm["EGLKIHF_L_1"]+adm["EGLKIHF_L_2"]+adm["EGLKIHF_L_3"]+adm["KLNM_L_1"]+adm["KLNM_L_2"]+adm["KLNM_L_3"]>=1;
subject to ai8:
	adm["EGLKIHF_K_1"]+adm["EGLKIHF_K_2"]+adm["EGLKIHF_K_3"]+adm["HIKJ_K_1"]+adm["HIKJ_K_2"]+adm["KLNM_K_1"]+adm["KLNM_K_2"]+adm["KLNM_K_3"]>=3;
subject to ai19:
	adm["EGLKIHF_I_1"]+adm["EGLKIHF_I_2"]+adm["EGLKIHF_I_3"]+adm["HIKJ_I_1"]+adm["HIKJ_I_2"]>=1;
subject to ai20:
	adm["EGLKIHF_H_1"]+adm["EGLKIHF_H_2"]+adm["EGLKIHF_H_3"]+adm["HIKJ_H_1"]+adm["HIKJ_H_2"]>=2;
subject to ai21:
	adm["EGLKIHF_F_1"]+adm["EGLKIHF_F_2"]+adm["EGLKIHF_F_3"]>=1;
subject to ai22:
	adm["HIKJ_J_1"]+adm["HIKJ_J_2"]>=2;
subject to ai23:
	adm["KLNM_N_1"]+adm["KLNM_N_2"]+adm["KLNM_N_3"]>=3;
subject to ai24:
	adm["KLNM_M_1"]+adm["KLNM_M_2"]+adm["KLNM_M_3"]>=1;
