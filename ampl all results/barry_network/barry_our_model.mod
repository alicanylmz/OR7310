...
subject to ai7:
	adm["ABLNIKMQHD_M_1"]+adm["ABLNIKMQHD_M_2"]+adm["ABLNIKMQHD_M_3"]+adm["ABLNIKMQHD_M_4"]+adm["MEGRCOSQ_M_1"]+adm["MEGRCOSQ_M_2"]+adm["MEGRCOSQ_M_3"]+adm["MEGRCOSQ_M_4"]+adm["MEGRCOSQ_M_5"]+adm["MEGRCOSQ_M_6"]>=2;
subject to ai8:
...
subject to ai22:
	adm["ABLNIKMQHD_Q_1"]+adm["ABLNIKMQHD_Q_2"]+adm["ABLNIKMQHD_Q_3"]+adm["ABLNIKMQHD_Q_4"]+adm["MEGRCOSQ_Q_1"]+adm["MEGRCOSQ_Q_2"]+adm["MEGRCOSQ_Q_3"]+adm["MEGRCOSQ_Q_4"]+adm["MEGRCOSQ_Q_5"]+adm["MEGRCOSQ_Q_6"]+adm["ABLNIKMQHD_M_1"]+adm["ABLNIKMQHD_M_2"]+adm["ABLNIKMQHD_M_3"]+adm["ABLNIKMQHD_M_4"]+adm["MEGRCOSQ_M_1"]+adm["MEGRCOSQ_M_2"]+adm["MEGRCOSQ_M_3"]+adm["MEGRCOSQ_M_4"]+adm["MEGRCOSQ_M_5"]+adm["MEGRCOSQ_M_6"]>=7;
subject to ai23:
	adm["ABLNIKMQHD_K_1"]+adm["ABLNIKMQHD_K_2"]+adm["ABLNIKMQHD_K_3"]+adm["ABLNIKMQHD_K_4"]+adm["IPTUJFK_K_1"]+adm["IPTUJFK_K_2"]+adm["IPTUJFK_K_3"]+adm["ABLNIKMQHD_I_1"]+adm["ABLNIKMQHD_I_2"]+adm["ABLNIKMQHD_I_3"]+adm["ABLNIKMQHD_I_4"]+adm["IPTUJFK_I_1"]+adm["IPTUJFK_I_2"]+adm["IPTUJFK_I_3"]>=8;
# Cuts you make
# subject to
	# TODO
